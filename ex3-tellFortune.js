...
function tellFortune(numKids, partnerNames, locations, jobTitles /* TODO add parameter(s) here */) {
  // TODO complete this function
...
function main() {
  ...
  const partnerNames = [
    // TODO add elements here
      "John Depp", "Sylvester", "Felipe", "Rambo", "Travolta", "Peter"
  ];

  const locations = [
    // TODO add elements here
      "Ukraine", "Mexico", "Germany", "Belgium", "Spain", "Japan", "Africa", "Australia"
  ];

  const jobTitles = [
    // TODO add elements here
      "SW developer", "Cook", "Engineer", "Businessman", "Economist", "Accountant"
  ];
